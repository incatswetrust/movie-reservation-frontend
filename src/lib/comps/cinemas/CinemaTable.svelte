      ...
      <thead class="bg-black bg-opacity-90 text-cyan-100 uppercase tracking-wider">
        <tr>
          ...
          <th class="px-4 py-2 border-b border-cyan-500">
            ...
            <button aria-label="add-new" on:click={OpenNewCinemaModal} class="inline-block rounded-sm bg-transperent px-4 py-2 text-xs font-medium text-cyan-300 hover:text-cyan-100 transition-colors">
      ...
      <tbody class="divide-y divide-cyan-700">
        ...
        <tr class="hover:bg-cyan-900 hover:bg-opacity-20 transition-colors">
          ...
          <td class="px-4 py-2 whitespace-nowrap">
            ...
            <button aria-label="edit" on:click={(async() => await Edit(cinema.id))} class="inline-block rounded-sm bg-transperent px-4 py-2 text-xs font-medium text-cyan-300 hover:text-cyan-100 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
