...
>
  <div 
    class="w-full max-w-md p-6 bg-black bg-opacity-80 border border-cyan-500 shadow-[0_0_15px_#0ff] rounded-md"
  >
    ...
    <input bind:value={newCinema.name}
      id="username"
      type="text"
      class="
    ...
    <input bind:value={newCinema.address}
      id="password"
      type="text"
      class="
